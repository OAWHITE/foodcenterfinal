            ...
            <div className="flex flex-col">
              <div className="flex flex-col text-center">
                <div className="flex flex-col items-center card-bg shadow-lg">
                  ...
                  <h3 className="mt-7 text-2xl font-semibold leading-6 text-orange-400"> Recipes in your hands </h3>
                  <p className="mt-6 leading-6 footer-cards-description text-xl p-2"> In the artist's own experience, of course, art is fundamentally indefinable, unsayable; there is something sacred about its demands </p>
                </div>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="flex flex-col text-center">
                <div className="flex flex-col items-center card-bg shadow-lg">
                  ...
                  <h3 className="mt-7 text-2xl font-semibold leading-6 text-orange-400"> Choose your food </h3>
                  <p className="mt-6 leading-6 footer-cards-description text-xl p-2"> In the artist's own experience, of course, art is fundamentally indefinable, unsayable; there is something sacred about its demands </p>
                </div>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="flex flex-col text-center">
                <div className="flex flex-col items-center card-bg shadow-lg">
                  ...
                  <h3 className="mt-7 text-2xl font-semibold leading-6 text-orange-400"> Enjoy! </h3>
                  <p className="mt-6 leading-6 footer-cards-description text-xl p-2"> In the artist's own experience, of course, art is fundamentally indefinable, unsayable; there is something sacred about its demands </p>
                </div>
              </div>
            </div>
